...
<section class="posts">
   ...
   <div class="box-container">
      ...
      <?php
         $select_posts = mysqli_query($conn, "SELECT * FROM `posts` LIMIT 6") or die('query failed');
         if(mysqli_num_rows($select_posts) > 0){
            while($fetch_posts = mysqli_fetch_assoc($select_posts)){
      ?>
      <form action="" method="POST" class="box">
         <a href="view_page.php?pid=<?php echo $fetch_posts['id']; ?>" class="fas fa-eye"></a>
...
<section class="home-contact">
   ...
   <div class="content">
      ...
      <p>We're happy to assist you with any concerns or information you need. Get in touch with us today!</p>
