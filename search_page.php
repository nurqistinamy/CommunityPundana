...
<section class="search-form">
    <form action="" method="POST">
        <input type="text" class="box" placeholder="search posts..." name="search_box">
   ...
   <div class="box-container">
      ...
      <?php
        if(isset($_POST['search_btn'])){
         ...
         $select_posts = mysqli_query($conn, "SELECT * FROM `posts` WHERE name LIKE '%{$search_box}%'") or die('query failed');
